...
For tasks with complex features, neural networks are more suitable. They enable extracting distinct features in complex images, such as torpedo targets. We use the YOLOv11 nano model.
![Several red and white pvc poles with bounding boxes drawn around them](/assets/images/software/slalom_detection.png "Detections performed by a YOLOv11 model"){ .w-[40vw] .mr-auto .ml-auto .block }
